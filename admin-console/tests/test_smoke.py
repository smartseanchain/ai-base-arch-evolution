...
class TestAdminConsoleSmoke(unittest.TestCase):
    ...
    def test_index_dashboard_html(self) -> None:
        ...
        self.assertIn('id="link-contributing-five-minute"', body)
        self.assertIn("CONTRIBUTING.md#contributing-five-minute", body)
        self.assertIn('id="link-contributing-pr-evidence-triad"', body)
        self.assertIn("CONTRIBUTING.md#contributing-pr-evidence-triad", body)
        self.assertIn('id="link-contributing-change-to-command"', body)
        self.assertIn("CONTRIBUTING.md#contributing-change-to-command", body)

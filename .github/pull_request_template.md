...
## 真源 touched（便于 reviewer 一眼扫）

- [ ] **`scripts/evolution-registry.json`** / **`spa/nav.config.json`** / **`make gen-nav-links`** 相关，或注明「未触及」
- [ ] **`partials/site-nav.inc.html`** / **`partials/skip-bar.inc.html`**（若触及须已 **`make sync-nav`**，并视情况手调 **404** / **legacy**），或注明「未触及」

**开 PR 前速览** · **PR 证据三联** · **动手→命令速查**（与根 `make help` 文首三锚对表）：[CONTRIBUTING · #contributing-five-minute](../CONTRIBUTING.md#contributing-five-minute) · [CONTRIBUTING · #contributing-pr-evidence-triad](../CONTRIBUTING.md#contributing-pr-evidence-triad) · [CONTRIBUTING · #contributing-change-to-command](../CONTRIBUTING.md#contributing-change-to-command)
